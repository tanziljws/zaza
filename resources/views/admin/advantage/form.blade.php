...
@php
$routeBase = 'admin.advantage';
$model = isset($advantage) ? $advantage : null;
        ...
        <div class="card mt-24">
            <div class="card-body p-24">
                <form id="form"
                    ...
                    <x-admin.form-input label="Icon  *  Font Awesome 4.7.0(Example:fa fa-certificate)" name="icon" type="text" 
                        value="{{ $model->icon ?? '' }}" placeholder="Enter icon" />
