            ...
            <table class="table bordered-table sm-table mb-0 text-sm">
                <thead>
                    <tr>
                        ...
                        <th>End Date by Contract</th>
                        <th>End Date by BA Lap Akhir</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ Str::limit($item->bidang_pekerjaan ?? '-', 50) }}</td>
                        <td>{{ Str::limit($item->sub_bidang_pekerjaan ?? '-', 50) }}</td>
                        <td>{{ Str::limit($item->location ?? '-', 50) }}</td>
                        <td>{{ Str::limit($item->client_name ?? '-', 50) }}</td>
                        <td>{{ Str::limit($item->client_address ?? '-', 50) }}</td>
                        <td>{{ Str::limit($item->contract_no_date ?? '-', 50) }}</td>
                        <td>{{ number_format($item->contact_value ?? 0, 2) }}</td>
                        <td>{{ Str::limit($item->end_date_by_contact ?? '-', 50) }}</td>
                        <td>{{ Str::limit($item->end_date_by_ba_lap_akhir ?? '-', 50) }}</td>
