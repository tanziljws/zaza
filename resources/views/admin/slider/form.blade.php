...
@php
$routeBase = 'admin.slider';
$model = isset($slider) ? $slider : null;
        ...
        <div class="card mt-24">
            <div class="card-body p-24">
                <form id="form"
                    ...
                    <x-admin.form-input label="Description" name="description" type="text" 
                        value="{{ $model->description ?? '' }}" placeholder="Enter description" />


                    <x-admin.form-input label="Image" name="image" type="file" accept="image/*" />
